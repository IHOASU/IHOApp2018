...
public class PerEventsViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        textView.setText(i.getStringExtra(FragmentFieldsMapping.KEY_EVENT_TITLE.getColumnName()));
        textView1.setText(i.getStringExtra(FragmentFieldsMapping.KEY_EVENT_WHEN.getColumnName()));
        textView2.setText(i.getStringExtra(FragmentFieldsMapping.KEY_EVENT_WHERE.getColumnName()));
        textView3.setText(i.getStringExtra(FragmentFieldsMapping.KEY_EVENT_DESC.getColumnName()));
        return v;
    }
